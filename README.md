...
## Features
- Real-time temperature, humidity, visibility, and wind
- 5-day weather forecast
- Air quality index ($CO$, $SO_2$, $O_3$, $NO_2$)
- Search by clicking the icon or pressing **Enter**
- Responsive glassmorphism design[cite: 10]
